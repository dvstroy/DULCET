...
public class CamFollow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.Rotate(new Vector3(0, Input.GetAxis("Mouse X") * camXSensitivity, 0));
        ...
        //myCam.transform.Rotate(new Vector3(currentMouseChange * -camYSensitivity, 0, 0));
        //myCam.transform.Translate(new Vector3(0, currentMouseChange * -0.1f, 0), Space.World);
        //currentMouseHeight += currentMouseChange;

        //transform.position = Vector3.Lerp(transform.position, followTarget.transform.position, lerpSpeed);
